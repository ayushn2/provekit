use {
    ...
    ark_std::{One, Zero},
    provekit_common::{
        hash::{ActiveSponge, ActiveMerkleConfig},
        utils::{
            pad_to_power_of_two,
            sumcheck::{
...
pub struct WhirR1CSCommitment {
    pub commitment_to_witness: Witness<FieldElement, ActiveMerkleConfig>,
...
pub trait WhirR1CSProver {
    fn commit(
        &self,
        merlin: &mut ProverState<ActiveSponge, FieldElement>,
        r1cs: &R1CS,
    ...
    fn prove(
        &self,
        merlin: ProverState<ActiveSponge, FieldElement>,
        r1cs: R1CS,
...
impl WhirR1CSProver for WhirR1CSScheme {
    ...
    fn prove(
        &self,
        mut merlin: ProverState<ActiveSponge, FieldElement>,
        r1cs: R1CS,
...
pub fn batch_commit_to_polynomial(
    ...
    Witness<FieldElement, ActiveMerkleConfig>,
...
fn create_combined_statement_over_two_polynomials<const N: usize>(
    cfg_nv: usize,
    witness: &Witness<FieldElement, ActiveMerkleConfig>,
...
pub fn run_zk_whir_pcs_prover(
    witnesses: Witness<FieldElement, ActiveMerkleConfig>,
